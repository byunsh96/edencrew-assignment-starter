...
import 'package:edencrew_assignment_starter/widgets/app_tab_bar.dart';
...
void main() {
  ...
  testWidgets('시작 화면이 다크 테마로 렌더링된다', (WidgetTester tester) async {
    await tester.pumpWidget(MultiProvider(providers: AppProviders.global, child: const EdencrewAssignmentApp()));
