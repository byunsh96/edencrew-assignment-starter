...
class LogUtil {
  ...
  void logInfo(String message, {String? module}) => _write('INFO', message, module);

  void logNetwork(String message, {String? module}) => _write('NETWORK', message, module);

  /// 에러는 원인 추적이 막히면 안 되므로 항상 남긴다.
  void logError(String message, {String? module, Object? error, StackTrace? stackTrace}) {
